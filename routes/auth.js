...
const client = new Client()
    ...
    .setProject('64f2250bf1ebe2e391ad')                // Your project ID
    .setKey('');         // Your secret API key
...
router.post("/register", async (req, res) => {
    try {
        ...
        // let newUser = new User({ email, name,username, password:hashedPassed });
        // await newUser.save();

        // Generate Token
        // const jwtData = { _id: user._id, name: user.name };
        // const jwtData = { newUser };
        // const token = jwt.sign(jwtData, process.env.JWTSECRET, { expiresIn: "30d" });
